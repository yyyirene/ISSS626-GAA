...
note：Polygon shapes may be complex or irregular, and directly calculating the distance between boundaries will increase the computational cost. The centroid is a fixed point of the polygon, and calculating the distance between centroids can simplify the whole process.
...
```{r}
write_rds(SIM_data, "data/rds/flow_data_6-9.rds")
```
...
![](formula1.png){width="404" height="71"}
