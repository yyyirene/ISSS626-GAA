...
### **3.4.3** Visualising target areas** NKDE
...
cv_scores <- bw_tnkde_cv_likelihood_calc(
  bws_net = seq(200, 1100, 100),  # 网络带宽使用 seq() 来创建带宽序列
  bws_time = seq(10, 70, 10),     # 时间带宽使用 seq() 来创建时间带宽序列
  lines = road_b,
  events = acci_b,
  time_field = "Time",
  w = rep(1, nrow(acci_b)),
...
According to the “leave one out cross validation” method, the optimal set of bandwidths is 3000 metres and 70 days.
